/**
 * FieldSelector - Interactive questionnaire to help users pick metadata fields
 *
 * Features:
...
export function FieldSelector({ onComplete, initialPattern, initialStep = 'questionnaire' }: FieldSelectorProps) {
