/**
 * Entity Dictionary Data
 *
 * Comprehensive reference data for all Atlan MDLH entity types.
 * Organized by category matching the Atlan metadata hierarchy.
 */

import type { EntityRow } from './dictionary-config';

export const ENTITY_DATA: Record<string, EntityRow[]> = {
  core: [
...
// Helper to get all entities across all categories
export function getAllEntities(): EntityRow[] {
  return Object.values(ENTITY_DATA).flat();
}
