 ...
 */
export function buildScopePrefix(scope: AssessmentScope): string {
 ...
 */
export function buildScopeFilter(scope: AssessmentScope): Record<string, unknown> {
 ...
 */
export function validateScope(scope: AssessmentScope): {
  valid: boolean;
  errors: string[];
  warnings: string[];
} {
...
export function createConnectionScope(
  ...
  options?: Partial<AssessmentScope>
): AssessmentScope {
  return {
    level: 'connection',
