 ...
 * - Binding matrix (measure → Atlan field mappings)
 * - Completeness scoring (weighted field scoring)
 * - Metadata model data (field library)
 * - Atlan compatibility (alias mappings)
 *
 * Each field defines:
...
const qualityFields: UnifiedField[] = [
  ...
  {
    id: 'dq_anomalo_check_count',
    displayName: 'Anomalo Check Count',
    description: 'Number of Anomalo checks configured.',
    category: 'quality',
    source: { type: 'native', attribute: 'assetAnomaloCheckCount' },
    supportedAssetTypes: ['Table', 'View', 'MaterialisedView'],
    contributesToSignals: [
      { signal: 'QUALITY', weight: 0.8 },
    ],
...
const dataProductFields: UnifiedField[] = [
  {
    id: 'data_product_status',
    displayName: 'Data Product Status',
    description: 'Status of the data product.',
    category: 'governance',
    source: { type: 'native', attribute: 'dataProductStatus' },
    supportedAssetTypes: ['DataProduct', 'Table', 'View'],
    contributesToSignals: [
      { signal: 'TRUST', weight: 0.5 },
    ],
    useCases: ['data_products'],
    coreForUseCases: ['data_products'],
    status: 'active',
  },
  {
    id: 'data_product_criticality',
    displayName: 'Data Product Criticality',
    description: 'Business criticality of the data product.',
    category: 'governance',
    source: { type: 'native', attribute: 'dataProductCriticality' },
    supportedAssetTypes: ['DataProduct', 'Table', 'View'],
    contributesToSignals: [],
    useCases: ['data_products', 'rca'],
    coreForUseCases: [],
    status: 'active',
  },
  {
    id: 'data_product_sensitivity',
    displayName: 'Data Product Sensitivity',
    description: 'Sensitivity level of the data product.',
    category: 'governance',
    source: { type: 'native', attribute: 'dataProductSensitivity' },
    supportedAssetTypes: ['DataProduct', 'Table', 'View'],
    contributesToSignals: [
      { signal: 'SENSITIVITY', weight: 0.5 },
    ],
    useCases: ['data_products', 'dsar_retention'],
    coreForUseCases: [],
    status: 'active',
  },
  {
    id: 'data_product_visibility',
    displayName: 'Data Product Visibility',
    description: 'Visibility scope of the data product.',
    category: 'governance',
    source: { type: 'native', attribute: 'dataProductVisibility' },
    supportedAssetTypes: ['DataProduct', 'Table', 'View'],
    contributesToSignals: [
      { signal: 'ACCESS', weight: 0.3 },
    ],
    useCases: ['data_products'],
    coreForUseCases: [],
    status: 'active',
...
// =============================================================================
// RETENTION FIELDS (Custom Metadata - Tenant Configurable)
// =============================================================================

const retentionFields: UnifiedField[] = [
  {
    id: 'retention_policy',
    ...
    source: {
      type: 'custom_metadata',
      businessAttribute: 'DataGovernance',
    ...
    measureId: 'coverage.retention_policy',
    useCases: ['dsar_retention'],
    coreForUseCases: ['dsar_retention'],
    status: 'experimental',
  },
  {
