...
FROM ${fqn}
WHERE TO_JSON(OUTPUTS) ILIKE '%' || ${escapeStringValue(tableGuid)} || '%'
LIMIT 50;`
    });
  }
...
SELECT 
    ...
    TO_JSON(OUTPUTS) AS downstream_assets
FROM ${fqn}
WHERE TO_JSON(INPUTS) ILIKE '%' || ${escapeStringValue(tableGuid)} || '%'
LIMIT 50;`
    });
  }
...
SELECT 
    ...
    CERTIFICATESTATUS
FROM ${fqn}
WHERE TO_JSON(ANCHOR) ILIKE '%' || ${escapeStringValue(glossaryGuid)} || '%'
ORDER BY NAME
LIMIT 100;`
    });
  }
