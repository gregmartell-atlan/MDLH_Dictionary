...
-- Note: INPUTS/OUTPUTS are ARRAY<OBJECT>, cast to VARCHAR for ILIKE search
...
WHERE 
    "INPUTS"::VARCHAR ILIKE '%${safeGuid}%'
    OR "OUTPUTS"::VARCHAR ILIKE '%${safeGuid}%'
LIMIT 10;`;
        }
...
WHERE ARRAY_CONTAINS('${safeGuid}'::VARIANT, p.${oppositeColumn})
LIMIT 20;
